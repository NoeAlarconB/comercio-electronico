	...
	<header>
		<div class="container mx-auto flex justify-between h-[75px] items-center">
            ...
            <div class="flex space-x-6 text-sm uppercase font-semibold">
				...
				<a href="/comercio-electronico/marcas" class="text-ml font-bold p-2 transition duration-300 hover:text-green-400 hover:shadow-sm rounded-md cursor-pointer border border-green border-solid">Marcas</a>
		...
		<div class="flex w-full justify-center p-4 gap-8 flex-wrap">
			...
			<div class="flex bg-gray-200 hover:scale-103 transition transform duration-300 w-[200px] 
				 ...
				 border-solid hover:border-green-600 cursor-pointer">
					...
					<span class="text-center font-bold "><%= marca.getNombre() %></span>
					<span class="text-sm font-bold text-center mt-2"><%= marca.getDescripcion() %></span>
			</div>	
