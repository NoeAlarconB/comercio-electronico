	...
	<header>
		<div class="container mx-auto flex justify-between h-[75px] items-center">
            ...
            <ul class="flex space-x-6 text-sm uppercase font-semibold">
				...
				<li><a href="/comercio-electronico/categorias" class="text-ml font-bold p-2 transition duration-300 hover:text-green-400 hover:shadow-sm">Categorias</a></li>
				<li><a href="/comercio-electronico/marcas" class="text-ml font-bold p-2 transition duration-300 hover:text-green-400 hover:shadow-sm rounded-md cursor-pointer border border-green border-solid">Marcas</a></li>
